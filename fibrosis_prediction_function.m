...
% Auto-generated by MATLAB on 07-Sep-2024 12:39:00
...
predictorNames = {'min', 'max', 'mean', 'sd', 'Vccm3'};
predictors = inputTable(:, predictorNames);
response = inputTable.yesOrNo;
...
trainedClassifier.RequiredVariables = {'min', 'max', 'mean', 'sd', 'Vccm3'};
